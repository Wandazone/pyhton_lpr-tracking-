...
plateCascade = cv2.CascadeClassifier("C:\\nomorplat\DeteksiPlatNomor-main\\haarcascade_russian_plate_number.xml")

# Membuka akses webcam
cam = cv2.VideoCapture('rtsp://admin:Knn54321@172.16.3.32:554/cam/realmonitor?channel=1&subtype=1')
...
while True:
    ...
    if k%256 == 27:
        ...
        cv2.imwrite("D:\hasil\hasil"+str(count)+".jpg", imgRoi)
